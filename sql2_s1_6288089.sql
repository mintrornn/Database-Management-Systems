...
VALUE(101, 'Charles', 'Xavier', '1975-05-04', 'CIS', NULL),
	(702, 'Stephen', 'Strange', '1988-07-04', 'BIOL', '7702');

DESCRIBE student;
-- insert student
INSERT INTO student(STU_NUM, STU_fname, STU_lname, STU_DOB, STU_CLASS, STU_GPA, DEPT_CODE, EMP_NUM)
VALUE(773355, 'Intr-orn', 'Lertsupakitsin', '2001-04-26', '1', '3.50', 'CIS', 702);
...
DESCRIBE course;
SELECT COURSE_CODE, COURSE_NAME, CRS_CREDIT*250 AS TUTITON_FEE, DEPT_CODE 
FROM course
...
SELECT CLASS_CODE, COURSE_CODE, CLASS_ROOM
FROM class;
...
SELECT EMP_FNAME AS Firstname, EMP_LNAME AS Lastname, 2020-YEAR(EMP_DOB) as Age
FROM professor
LIMIT 10;
...
SELECT STU_FNAME, STU_LNAME, STU_GPA
FROM student
WHERE STU_GPA BETWEEN 3.25 AND 3.50;
...
SELECT STU_FNAME, STU_LNAME
FROM student
WHERE YEAR(STU_DOB) > 1970 ;-- phpMyAdmin SQL Dump
-- version 4.9.1
-- https://www.phpmyadmin.net/
--
-- Host: localhost
...
SELECT STU_FNAME, STU_LNAME
FROM student
WHERE YEAR(STU_DOB) >= 1970 AND YEAR(STU_DOB) <= 1979;
...
FROM class
WHERE EMP_NUM like '%104%' or EMP_NUM like '%105%' or EMP_NUM like '%106%' or EMP_NUM like '%155%';